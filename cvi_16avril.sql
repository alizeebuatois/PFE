...
--
-- Client :  localhost
-- Généré le :  Jeu 16 Avril 2015 à 10:12
...
(1, 'CXiL45fLwB', 7, '2015-03-12', 'DZYLbabebx', ''),
(5, 'CXiL45fLwB', 7, '2015-03-01', 'bidulle', ''),
(6, 'toc', 7, '2015-03-17', 'bob', ''),
(7, 'CHqzAtlyYI', 7, '2015-03-23', 'DZYLbabebx', ''),
(8, 'CHqzAtlyYI', 7, '2015-03-16', 'DZYLbabebx', ''),
(9, 'CmSUGWZvnv', 1, '2014-12-08', 'DURXPAC6rx', 'ras'),
(10, 'CmSUGWZvnv', 1, '2015-02-09', 'DURXPAC6rx', 'ras');
...
(19, 'CmSUGWZvnv', 1, 2000, '2015-04-16', 'DZYLbabebx', 'coucou'),
(20, 'CmSUGWZvnv', 1, 2000, '2015-04-16', 'DZYLbabebx', 'coucou2');
...
(1, NULL, '[{"date":"2015-02-10","lot":""}]', '[{"id":"5","date":"2015-02-10","comment":"essai"},{"id":"5","date":"2015-02-25","comment":"truc"}]', '[{"historic_id":"19","id":"1","date":"2015-04-16","lot":"2000","comment":"coucou"},{"historic_id":"11","id":"1","date":"2015-04-16","lot":"2000","comment":"coucou2"}]');
...
INSERT INTO `partnership` (`partnership_a_user_key`, `partnership_b_user_key`, `partnership_creator_user_key`, `partnership_ack`, `partnership_creation`) VALUES
('UbJOwUMdfi', 'UjlUPkp8DI', 'UbJOwUMdfi', 0, '2015-03-25 15:32:37');

-- --------------------------------------------------------

--
-- Structure de la table `stockCurrent`
--

CREATE TABLE IF NOT EXISTS `stockCurrent` (
`stock_id` int(11) NOT NULL,
  `stock_vaccin_id` int(15) NOT NULL,
  `stock_vaccin_lot` int(30) NOT NULL,
  `stock_quantity_lot` int(30) NOT NULL,
  `stock_remaining` int(30) NOT NULL,
  `stock_last_update` date NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=31 ;

--
-- Contenu de la table `stockCurrent`
--

INSERT INTO `stockCurrent` (`stock_id`, `stock_vaccin_id`, `stock_vaccin_lot`, `stock_quantity_lot`, `stock_remaining`, `stock_last_update`) VALUES
(1, 1, 2000, 50, 25, '2015-04-16'),
(3, 26, 9898, 75, 75, '2015-04-07'),
(5, 137, 4000, 10, 8, '2015-04-15'),
(6, 24, 12345, 12, 12, '2015-04-09'),
(7, 24, 123456, 13, 13, '2015-04-09'),
(8, 137, 13, 60, 50, '2015-04-09'),
(9, 26, 45, 45, 45, '2015-04-09'),
(10, 7, 44, 23, 23, '2015-04-09'),
(11, 24, 12, 12, 12, '2015-04-09'),
(13, 2, 1600, 80, 70, '2015-04-09'),
(14, 8, 0, 0, 0, '2015-04-14'),
(15, 24, 1234, 1234, 1234, '2015-04-14'),
(16, 28, 12345, 12345, 12345, '2015-04-14'),
(17, 28, 12345, 12345, 12345, '2015-04-14'),
(19, 28, 12, 12, 12, '2015-04-14'),
(20, 28, 123, 123, 123, '2015-04-14'),
(21, 24, 2222, 2222, 2221, '2015-04-15'),
(22, 24, 123, 123, 123, '2015-04-14'),
(24, 28, 123, 123, 123, '2015-04-14'),
(25, 137, 2123, 2324, 2324, '2015-04-14'),
(29, 137, 1233, 123, 123, '2015-04-14'),
(30, 137, 123, 123, 123, '2015-04-14');
...
`stock_id` int(11) NOT NULL,
  `stock_vaccin_id` int(15) NOT NULL,
  `stock_lot` int(30) NOT NULL,
  `stock_quantity_lot` int(30) NOT NULL,
  `stock_date` date NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=43 ;

--
-- Contenu de la table `stockLot`
--

INSERT INTO `stockLot` (`stock_id`, `stock_vaccin_id`, `stock_lot`, `stock_quantity_lot`, `stock_date`) VALUES
(1, 1, 1000, 60, '2015-03-10'),
(2, 1, 1500, 50, '2015-03-28'),
(5, 7, 23, 23, '0000-00-00'),
(6, 12, 1, 2, '0000-00-00'),
(7, 137, 15, 56, '2015-04-02'),
(14, 26, 9898, 75, '2015-04-07'),
(15, 137, 2323, 500, '2015-04-07'),
(16, 137, 2424, 600, '2015-04-07'),
(17, 137, 4000, 10, '2015-04-07'),
(18, 24, 12345, 12, '2015-04-09'),
(19, 24, 123456, 13, '2015-04-09'),
(20, 137, 13, 60, '2015-04-09'),
(21, 26, 45, 45, '2015-04-09'),
(22, 7, 44, 23, '2015-04-09'),
(23, 24, 12, 12, '2015-04-09'),
(25, 2, 1600, 80, '2015-04-09'),
(41, 137, 1233, 123, '2015-04-14'),
(42, 137, 123, 123, '2015-04-14');

-- --------------------------------------------------------

--
-- Structure de la table `stockRegulation`
--

CREATE TABLE IF NOT EXISTS `stockRegulation` (
`stock_id` int(11) NOT NULL,
  `stock_vaccin_id` int(15) NOT NULL,
  `stock_vaccin_lot` int(30) NOT NULL,
  `stock_theorical_quantity` int(30) NOT NULL,
  `stock_real_quantity` int(30) NOT NULL,
  `stock_date` date NOT NULL,
  `stock_comment` text NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=133 ;

--
-- Contenu de la table `stockRegulation`
--

INSERT INTO `stockRegulation` (`stock_id`, `stock_vaccin_id`, `stock_vaccin_lot`, `stock_theorical_quantity`, `stock_real_quantity`, `stock_date`, `stock_comment`) VALUES
(1, 1, 2000, 45, 43, '2015-04-01', 'tests'),
(120, 1, 5555, 33, 30, '2015-04-15', 'truc'),
(132, 2, 1600, 80, 70, '2015-04-09', '10 ratés');
...
(13, 'MarieColine', 'Traitement en cas de manque de bisous', '<p>Chaque jour :</p><ol><li>matin</li><li>midi</li></ol><ul><li>et soir</li></ul>');
...
(1, 'zmaakaroun', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'zmaakaroun@cvi.fr', '', '', '', '', 0, '0123456789', 'DZYLbabebx', 3, 1, 'UFD00c3wl4', '2014-03-20 15:14:49', '2015-04-16 07:29:54'),
...
(7, 'cauzemery', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', '', '', '', '', '', 0, NULL, 'DspmgOSucM', 2, 1, 'U6WRywMAcL', '2014-03-21 12:21:35', '2015-04-07 09:12:05'),
(8, 'alibua0704', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'buatois.alizee@gmail.com', '131 rue Victor Hugo', '', '37000', 'Tours', 83, NULL, 'CmSUGWZvnv', 0, 1, 'UbJOwUMdfi', '2014-10-25 17:20:35', '2015-04-14 12:22:11'),
...
(49, 'apinson1', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'aurelien.pinson@gmail.com', '', '', '', '', 0, '', 'DURXPAC6rx', 1, 1, 'Ubbb66sHtR', '2015-03-10 15:56:37', '2015-04-07 09:06:30'),
(50, 'fclarrec', 'd764579bb3f9cf9de9e215ded4b28e7229be1151', '', '', '', '', '', 0, '', 'Dbff7JmNrh', 1, 1, 'UpuDubj8e7', '2015-03-10 16:10:58', NULL),
(51, 'antaum3101', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'anthony.aumond@sfr.fr', '197 rue du Général Renault', '', '37000', 'Tours', 83, NULL, 'CXiL45fLwB', 0, 1, 'UjlUPkp8DI', '2015-03-11 08:20:08', '2015-03-25 09:33:12');
...
--
-- Index pour la table `stockCurrent`
--
...
--
-- Index pour la table `stockRegulation`
--
ALTER TABLE `stockRegulation`
 ADD PRIMARY KEY (`stock_id`);
...
--
ALTER TABLE `historicVaccin`
MODIFY `historic_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
...
--
-- AUTO_INCREMENT pour la table `stockCurrent`
--
ALTER TABLE `stockCurrent`
...
--
-- AUTO_INCREMENT pour la table `stockRegulation`
--
ALTER TABLE `stockRegulation`
MODIFY `stock_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=133;
--
...
--
ALTER TABLE `vaccin`
MODIFY `vaccin_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=143;
--
